...
namespace CashFlow.Exception {
    ...
    public class ResourceErrorMessages {
        ...
        /// <summary>
        ///   Consulta uma cadeia de caracteres localizada semelhante a The date must be previos today.
        /// </summary>
        public static string DATE_MUST_TODAY {
            get {
                return ResourceManager.GetString("DATE_MUST_TODAY", resourceCulture);
            }
        }
